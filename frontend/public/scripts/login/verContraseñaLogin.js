        ...
        botonVerContrasena.addEventListener("click", () => {
            ...
            botonVerContrasena.innerHTML = esOculta
                ? `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-6 h-6">
                     <path stroke-linecap="round" stroke-linejoin="round" d="M3 3l18 18M2.25 12s3.75-6.75 9.75-6.75c2.01 0 3.78.53 5.32 1.3M19.5 8.25c1.73 1.28 2.25 2.07 2.25 2.07s-3.75 6.75-9.75 6.75c-2.01 0-3.78-.53-5.32-1.3" />
                   </svg>`
                : `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-6 h-6">
            ...
            const textoAccion = esOculta ? "Ocultar contraseña" : "Ver contraseña";
            botonVerContrasena.title = textoAccion;
            botonVerContrasena.setAttribute("aria-label", textoAccion);
        });
    });
});